...
<div class="form-group{{ $errors->has('reading_room') ? ' has-error' : '' }}">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="reading_room" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="reading_room" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group{{ $errors->has('readingroom_size') ? ' has-error' : '' }}">
		...
		<div class="col-sm-4" >
			<input type="text" class="form-control" required id="readingroom_size" name="readingroom_size" >
...
<div class="form-group">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="preodical_room" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="preodical_room" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group{{ $errors->has('preodical_room_size') ? ' has-error' : '' }}">
		<div class="col-sm-1" >
		</div>
		<div class="col-sm-7" >
			<ul>
		...
		<div class="col-sm-4" >
			<input type="text" class="form-control" required id="preodical_room_size" name="preodical_room_size" >
			@if ($errors->has('preodical_room_size'))
			<span class="help-block">
				<strong>{{ $errors->first('preodical_room_size') }}</strong>
			</span>
			@endif
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="studyroom_for_staf" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="studyroom_for_staf" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group{{ $errors->has('studyroom_for_staf_size') ? ' has-error' : '' }}">
		<div class="col-sm-1" >
		</div>
		<div class="col-sm-7" >
			<ul>
		...
		<div class="col-sm-4" >
			<input type="text" class="form-control" required id="studyroom_for_staf_size" name="studyroom_for_staf_size" >
			@if ($errors->has('studyroom_for_staf_size'))
			<span class="help-block">
				<strong>{{ $errors->first('studyroom_for_staf_size') }}</strong>
			</span>
			@endif
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="science_lab" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="science_lab" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group{{ $errors->has('science_lab_size') ? ' has-error' : '' }}">
		...
		<div class="col-sm-7" >
			...
			<div class="col-sm-4" >
				<input type="text" class="form-control" required id="science_lab_size" name="science_lab_size" >
...
<!-- <div class="form-group{{ $errors->has('water_supply_details') ? ' has-error' : '' }}">
<div class="col-sm-1" >
</div>
<div class="col-sm-7" >
<ul>
...
<div class="col-sm-4" >
<input type="text" class="form-control" required id="water_supply_details" name="water_supply_details" >
@if ($errors->has('water_supply_details'))
<span class="help-block">
<strong>{{ $errors->first('water_supply_details') }}</strong>
</span>
@endif
</div>
</div>
...
<!-- <div class="form-group{{ $errors->has('electricity_details') ? ' has-error' : '' }}">
<div class="col-sm-1" >
</div>
<div class="col-sm-7" >
<ul>
...
<div class="col-sm-4" >
<input type="text" class="form-control" required id="electricity_details" name="electricity_details" >
@if ($errors->has('electricity_details'))
<span class="help-block">
<strong>{{ $errors->first('electricity_details') }}</strong>
</span>
@endif
</div>
</div>
...
<strong><input type="radio" name="inside_mc" value="1"><label>Yes
</label></strong>
<strong><input type="radio" name="inside_mc" value="0" checked><label>No
</label></strong>
</div>
</div> -->
</div>
...
<!-- <div class="col-sm-4">
<input type="text" class="form-control" required id="land_for_physical_education" name="land_for_physical_education" >
@if ($errors->has('land_for_physical_education'))
<span class="help-block">
<strong>{{ $errors->first('land_for_physical_education') }}</strong>
</span>
@endif
</div> -->
</div>
...
<!-- <div class="col-sm-4">
<input type="text" class="form-control" required id="mba_mca" name="mba_mca" >
@if ($errors->has('mba_mca'))
<span class="help-block">
<strong>{{ $errors->first('mba_mca') }}</strong>
</span>
@endif
</div> -->
</div>
...
<!-- <div class="col-sm-4">
<input type="text" class="form-control" required id="responsibility_of_society_interest" name="responsibility_of_society_interest" >
@if ($errors->has('responsibility_of_society_interest'))
<span class="help-block">
<strong>{{ $errors->first('responsibility_of_society_interest') }}</strong>
</span>
@endif
</div> -->
</div>
...
<div class="form-group{{ $errors->has('endorsement_fund') ? ' has-error' : '' }}">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="endorsement_fund" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="endorsement_fund" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4" >
		<div class="radio radio-inline">
			...
			<strong><input type="radio" name="resources" value="1"><label>Yes
			</label></strong>
			<strong><input type="radio" name="resources" value="0" checked><label>No
			</label></strong>
		</div>
	</div>
	<br>
	...
	<div class="form-group{{ $errors->has('resources_detail') ? ' has-error' : '' }}">
		...
		<div class="col-sm-7" >
			...
			<div class="col-sm-4" >
				<input type="text" class="form-control" required id="resources_detail" name="resources_detail" >
