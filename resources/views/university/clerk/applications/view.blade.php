...
<div class="form-horizontal">
	...
	<div style="text-align: center;" class="form-group{{ $errors->has('remarks') ? ' has-error' : '' }}">
		<h4 >
			<strong>
				<label for="remarks-placeholder" class="col-md-12 control-label">
					Final Remarks
				</label>
			</strong>
		</h4>
		...
		<div class="col-md-12">                       
			<textarea name="remarks-placeholder" oninput="viewbuttons()" onchange="viewbuttons()" id="remarks-placeholder" cols="92" rows="5" required>{{ old('remarks') }}</textarea>
	...
	<div class=" col-md-12" style="text-align: center;"> 
		<hr class="redhr">
		<a class="btn btn-primary" href="{{ route('clerkbacknotes',$form->college->id) }}">View Backnotes</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<script type="text/javascript">
			...
			function viewbuttons() {
				var remarks = document.getElementById("remarks-placeholder").value;
				if (remarks == '') {
					document.getElementById("sucessbtn").style.display = "none";
					document.getElementById("rejectbtn").style.display = "none";
				}
				else {
					document.getElementById("sucessbtn").style.display = "inline";
					document.getElementById("rejectbtn").style.display = "inline";
				}
			}
			function forwarddean() {

				var remarks = document.getElementById("remarks-placeholder").value;
				if (remarks != ''){
					document.getElementById('remarksforward').value = remarks;
			...
			function rejectapplication() {
				...
				var remarks = document.getElementById("remarks-placeholder").value;
				if (remarks != ''){
					document.getElementById('remarksreject').value = remarks;
