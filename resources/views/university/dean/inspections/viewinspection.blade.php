@extends('templates.dean.main',['title' => 'View Inspection'])
...
<div class=" col-md-12" style="text-align: center;"> 
	...
	@if(!$inspectionid->is_approved_by_dean)
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="btn btn-primary" href="{{ route('deanviewinspection',$inspectionid->id) }}"
	...
	<table width="100%">
		...
		<tr style="line-height:30px;">
			...
			<td>
				<label>
					<a class="btn btn-primary btn-xs" href="{{ route('deanviewinspection',$inspection->id) }}">View Inspection</a>

				</label>
			</td>
			<td>
				{!! $inspection->is_approved_by_dean ? "<span class='label label-success'>Approved</span>" : ($inspection->is_seen_by_dean ? "<span class='label label-warning'>Pending</span>" : "<span class='label label-danger'>New</span>") !!}
			</td>
		</tr>
		@endforeach
