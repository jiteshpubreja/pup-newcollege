@extends('templates.college.main',['title' => 'View Rejected Application'])
@section('heading')
...
<div class=" col-md-12" style="text-align: center;"> 
	...
	<table width="100%" style="text-align: center;">
		...
		<tr style="line-height:30px;">
			...
			<td>
				<label>
					{{ $application->deleted_at->toFormattedDateString() }}

				</label>
			</td>
			<td>
				<label>
					<a class="btn btn-primary btn-xs" href="{{ route('collegeviewrejected',$application->id) }}">View Application</a>
