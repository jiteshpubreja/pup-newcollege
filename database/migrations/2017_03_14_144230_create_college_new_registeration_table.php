...
class CreateCollegeNewRegisterationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('college_new_registeration', function (Blueprint $table) {
            ...
            $table->boolean('preodical_room')->default(0);
            $table->string('preodical_room_size')->nullable();
            $table->boolean('studyroom_for_staf')->default(0);
            $table->string('studyroom_for_staf_size')->nullable();
            $table->boolean('reading_room')->default(0);
            $table->string('readingroom_size')->nullable();
            ...
            $table->string('law_it_management_land');
            $table->string('inside_mc');
            $table->string('girls_science_art_college');
            $table->string('land_for_physical_education');
            $table->string('land_according_to_aicte');
            $table->string('mba_mca');
            $table->string('responsibility_of_society_interest');
            $table->string('certificate_from_tehsil');
